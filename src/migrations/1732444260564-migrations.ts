...
export class Migrations1732444260564 implements MigrationInterface {
    name = 'Migrations1732444260564'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "locale" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "language" character varying(255) NOT NULL, "code" character varying(255) NOT NULL, "created_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "updated_at" TIMESTAMP DEFAULT now(), CONSTRAINT "UQ_03f3269461e7b003dca6b1699f4" UNIQUE ("code"), CONSTRAINT "PK_4b7a3ebe8ec48f1bb2c4b80e349" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "created_at" TIMESTAMP DEFAULT '2024-11-24T10:31:01.635Z', "deleted_at" TIMESTAMP, "updated_at" TIMESTAMP DEFAULT '2024-11-24T10:31:01.636Z', CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "catalog" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "vertical" "public"."catalog_vertical_enum" NOT NULL, "is_primary" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "indexed_at" TIMESTAMP NOT NULL DEFAULT '2024-11-24T10:31:01.636Z', CONSTRAINT "UQ_408ad15a08984a8e9b0619ee3e5" UNIQUE ("name"), CONSTRAINT "PK_782754bded12b4e75ad4afff913" PRIMARY KEY ("id"))`);
